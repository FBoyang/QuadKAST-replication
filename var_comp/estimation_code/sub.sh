...
savePath=/u/scratch/b/boyang19/tmp/u/flashscratch/b/boyang19/QuadKAST/analysis/down_stream/results1/
...
python analysis1.py --tindex ${SGE_TASK_ID} --savePath $savePath
